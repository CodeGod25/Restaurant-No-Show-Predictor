...
MONGO_URI = os.getenv("MONGODB_URI", "mongodb+srv://Narasimha:Narasimha25@hotel-booking-cluster.zbedtur.mongodb.net/restaurant_predictions?retryWrites=true&w=majority&ssl=true&tlsAllowInvalidCertificates=true")
...
try:
    booster = xgb.Booster()
    booster.load_model("noshow_xgb.json")
    model = booster
